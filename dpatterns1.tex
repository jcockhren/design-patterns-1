...
\begin{document}
    ...
    \frame{
        ...
        \begin{center}
            \begin{definition}
                \textbf{intrinsic state} - sharable features that gives rise to an entity's uniqueness.
            \end{definition}
            \uncover<2->{
                \begin{definition}
    ...
    \frame{
        ...
        \begin{center}
            \begin{enumerate}
                \item <1-> Provide an \textbf{intrinsic state} of an object that represents only the numbers $5$, $15$ and $25$.
                \item <2-> Provide an \textbf{extrinsic state} of an object that represents only the numbers $5$, $15$, and $25$.
           \end{enumerate}
        \end{center}
    }
    \frame{
